package com.demo.pay.wxpay;

import cn.hutool.core.util.StrUtil;
import com.alibaba.fastjson.JSON;
import com.demo.pay.vo.AjaxResult;
import com.demo.pay.wxpay.domain.H5SceneInfo;
import com.demo.pay.wxpay.domain.WxPayBean;
...
public class WxPayController extends AbstractWxPayApiController {
    ...
    public String refund(@RequestParam("transactionId") String transactionId,
        ...
        if (StrUtil.isEmpty(outTradeNo) && StrUtil.isEmpty(transactionId)) {
